<template>
    <div class="cartcontroler-wrap">
        <span @click="decrease($event)" class="span-decrease"> 
        <svg v-show="num > 0"   t="1533714167213" class="icon-decrease" style="" viewBox="0 0 1024 1024" version="1.1"
